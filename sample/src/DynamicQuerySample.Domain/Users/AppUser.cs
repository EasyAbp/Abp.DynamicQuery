...
namespace DynamicQuerySample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DynamicQuerySampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DynamicQuerySampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
