...
{
    public static class DynamicQuerySampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE DynamicQuerySampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
